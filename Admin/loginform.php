...
<!--/sticky-->
<div style="padding-top:200px; box-shadow:1px 1px 20px black; min-height:670px" class="container">
...
<h1>Welcome to Smash Trip Admin Panel</h1>
<h3>please login to continue...</h3>


<form method="post">
<table border="0" width="400px" height="300px" align="left" class="tableshadow">
